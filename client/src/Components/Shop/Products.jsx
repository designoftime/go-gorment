...
const ProductReviews = ({ productId, styles }) => {
  ...
  return (
    <span style={styles?.color}>
      {" "}
      <span style={styles?.color}>{reviews?.totalReviews}</span> reviews
    </span>
  );
};
...
export const Products = ({ categoryId, variants, styles }) => {
  ...
  return (
    <div>
      <Swiper
        slidesPerView={
          showValue > 767 ? (products?.length <= 4 ? products.length : 4) : 1
        }
        spaceBetween={50}
      ...
      >
        <div
          className="ShopProducts-section container-fluid row justify-content-around g-0 pt-5 pb-5"
          style={styles?.fullBg}
        >
          {products.length
                    ...
                    >
                      <div className="ShopProducts-content text-center">
                        ...
                        <div
                          ...
                          style={styles?.color}
                        >
                          {findProductAttribute(product, variants)}
                        </div>
                        <div className="ShopProductsPrice fw-bold fs-5">
                          <span>&#8377;</span>
                          <span style={styles?.color}>
