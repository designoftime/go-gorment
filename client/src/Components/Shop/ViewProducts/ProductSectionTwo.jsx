...
const ProductSectionTwo = ({data}) => {
    ...
    return (
        <div className='container-fluid g-0 mt-5 py-5 ViewProductIconsSection' style={styles.fullBg}>
                      ...
                      sliderVal.map((val,idx)=>{
                        ...
                        return (
                            <div className='VPIcon-main py-5' key={idx}>
                                ...
                                <div className="VPIcon-content py-3 fw-bold fs-4 text-uppercase text-center" style={styles.color}>{data[`${val}_title`]} </div>
                            </div>
                        );
                       })
                    }
